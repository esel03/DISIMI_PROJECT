"""
Django settings for disimi project.
...
ALLOWED_HOSTS = ["81.94.159.44", "www.disimiproject.ru", "disimiproject.ru"]
...
ROOT_URLCONF = 'disimi.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['neuron.templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'disimi.wsgi.application'
